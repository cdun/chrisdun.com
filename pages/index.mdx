...
I'm currently working as a tech lead at Hopin, an events startup that grew rapidly during COVID-19. The teams I work with build apps and integrations that extend Hopin itself and tooling that enables third parties to do the same. I've enjoyed being able to spend much more time mentoring other engineers at Hopin both at a direct technical level and on their own career progression.
...
- Acting as a maintainer of Hopin's module federation framework
- Architecture / implementation of JavaScript SDK for Hopin apps
